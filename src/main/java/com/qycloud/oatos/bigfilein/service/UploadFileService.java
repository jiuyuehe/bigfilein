...
import com.qycloud.oatos.bigfilein.model.loacl.FileBlock;
...
public class UploadFileService {
     ...
     * @param fileMd5
     * @param fileName
     * @param fileSize 没有传输过的文件返回 ： {"statusCode":"OK","content":1}；
    ...
    public static String checkFile(String fileMd5, String fileName, long fileSize) {
        ...
        try {
            ...
            re = XhrProxy.post(Constant.getUrl(Constant.Check_URL), Constant.UT, param);
    ...
    private static String httpPost(String fileName, FileBlock fileBlock, byte[] by) {
        ...
        try {
            ...
            res = XhrProxy.post(Constant.getUrl(Constant.SECTION_UPLOAD_URL), reqEntity, headers);
